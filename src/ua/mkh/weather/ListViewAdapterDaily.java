...
public class ListViewAdapterDaily extends BaseAdapter {
	...
	public ListViewAdapterDaily(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View itemView = inflater.inflate(R.layout.list_item_daily, parent, false);
		// Get the position
